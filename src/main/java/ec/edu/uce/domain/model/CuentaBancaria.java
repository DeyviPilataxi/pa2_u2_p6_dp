...
public class CuentaBancaria {
    ...
    @Id
    @SequenceGenerator(name = "seq_cuenta_generador", sequenceName = "seq_cuenta_bancaria", allocationSize = 1)
    ...
    public String toString() {
        return "CuentaBancaria [id=" + id + ", numeroCuenta=" + numeroCuenta + ", saldo=" + saldo
                + ", transferenciasEnviadas=" + transferenciasEnviadas + ", transferenciasRecibidas="
